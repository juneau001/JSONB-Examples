...
import org.cjug.jsonbtest.entity.DiscountCode;
 ...
 */
@Stateless
@Path("org.cjug.jsonbtest.entity.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "org.cjug_JsonbTest_war_1.0-SNAPSHOTPU")
